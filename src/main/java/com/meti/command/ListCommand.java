...
public class ListCommand implements Command {
  ...
  @Override
  public void perform(Server server, ObjectInputStream inputStream, ObjectOutputStream outputStream)
      throws IOException {
    switch (type) {
      case TYPE_FILES: {
      ...
      default:
        outputStream.writeObject(
            new IllegalArgumentException("Argument of type " + type + " does not exist"));
